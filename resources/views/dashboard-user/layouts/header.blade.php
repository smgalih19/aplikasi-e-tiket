<header class="navbar sticky-top flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand px-3 fs-7 text-white" href="/">e-Ticket Pangandaran</a>
    ...
    <div id="navbarSearch" class="navbar-search w-50 collapse">
        <input class="form-control rounded-1 border-1" type="text" placeholder="Search" aria-label="Search">
    </div>
</header>
